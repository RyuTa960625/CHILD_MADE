        ...
        <Row>
          ...
          <Col className={styles.container_1} md="9">
            ...
            <div className={styles.main_container} id='main_container'>
              ...
              {/* 메인 비디오 화면 */}
              {mainStreamManager ? 
              <video className={styles.main_video} streammanager={publisher} autoPlay={true} ref={videoRef}/> : "화면 로딩중..."}
            ...
            <div className={styles.container_2}>
              ...
              <div className={styles.player}>
                {/* 참가자 비디오 1 */}
                {subscribers.length > 0 ? <video streamManager={subscribers[0]} autoPlay={true} ref={videoRef}/> : "참가자 대기중"}
              </div>

              <div className={styles.player}>
                {/* 참가자 비디오 2 */}
                {subscribers.length > 1 ? <video streamManager={subscribers[1]} autoPlay={true} ref={videoRef}/> : "참가자 대기중"}
              </div>

              <div className={styles.player}>
                {/* 참가자 비디오 3 */}
                {subscribers.length > 2 ? <video streamManager={subscribers[2]} autoPlay={true} ref={videoRef}/> : "참가자 대기중"}
              </div>
