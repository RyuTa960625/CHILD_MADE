...
export default function Single({ setShowHeader }) {
    ...
    const [roomFinish, setRoomFinish] = useState(false) // 방 종료를 위한 상태
    ...
    const createSession = async () => {
        if (playMode === "SINGLE") {
            const response = await axios.put(
                APPLICATION_SERVER_URL + `api/rooms/single/${memberId}`,
                {
                    roleId: roleId,
                    bookId: bookId,
                },
    ...
    return (
        ...
        <div className={styles.bg}>
            ...
            ></div>
            <div
                className={`${styles.star} ${styles.star2} ${styles.blinking2}`}
            ></div>
            <div
                className={`${styles.star} ${styles.star3} ${styles.blinking}`}
            ></div>
            <div
                className={`${styles.star} ${styles.star4} ${styles.blinking}`}
            ></div>
            <div
                className={`${styles.star} ${styles.star5} ${styles.blinking2}`}
            ></div>
            <div
                className={`${styles.star} ${styles.star6} ${styles.blinking}`}
            ></div>
            <div
                className={`${styles.star} ${styles.star7} ${styles.blinking2}`}
            ></div>
            <div
                className={`${styles.star} ${styles.star8} ${styles.blinking}`}
            ></div>
            <div
                className={`${styles.star} ${styles.star9} ${styles.blinking2}`}
            ></div>
            <div
                className={`${styles.star} ${styles.star10} ${styles.blinking}`}
            ></div>
            <div
                className={`${styles.star} ${styles.star11} ${styles.blinking2}`}
            ></div>
                            ...
                            <div className={styles.helperScript}>
                                {roomStart && helperScriptLine.length > 0 ? (
                                    helperScriptIndex <
                                        ...
                                        "동화가 끝이났어. 나가기 버튼을 눌러서 밖으로 나가면 돼! 안녕~🖐"
                                    )
                                ) : (
