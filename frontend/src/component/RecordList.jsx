    ...
    <div className={styles.main_container}>
...

      {
        ...
        <div className={styles.video_info_container}>
          <img className={styles.video_book}src="/imgs/detailBookM.png" alt="동영상 상세 보기 페이지"></img>
          <div>
              <img src='/imgs/close2M.png' alt='탈출' className={styles.close_icon}  onClick={openModal}></img>
          </div>
          ...
          <div className={styles.video_btn_container}>
            ...
            <div className={styles.video_btn}>
              <h1 className={styles.btn_text}>동화책 삭제하기</h1>
            </div>
          </div>
      ...
      <div className={styles.whole_container}>
        ...
        <div className={styles.search_container}>
          ...
          <img className={styles.find} src="../imgs/find2M.png" alt="돋보기"></img>
        </div>
        ...
        <div className={styles.video_shelf_container}>
          <div className={styles.video_container}>
            ...
            {/* 동화책 목록 */}
              {
                서버에서온데이터.map((data, index)=>{
                    return(
                        <>
                        <div className={styles.book_container} onClick={()=>{openModal();}}>
                            <img className={styles.book_img}  src={서버에서온데이터[index].imageUrl} alt='책 표지'/> 
                        </div>
                        </>
                    )
                })
            ...
            <div className={styles.wing_container}>
              <div className={styles.wm} style={{width : 330, height : 150, marginLeft : -170, position : 'absolute'}}>
                  <img src='/imgs/wLM.png' alt='왼쪽 날개' className={styles.wing1}></img>
              </div>
              <div className={styles.wm2} style={{width : 330, height : 150, marginLeft :1040, position : 'absolute'}}>
