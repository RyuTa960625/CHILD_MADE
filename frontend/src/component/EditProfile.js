  ...
  return (
    ...
    >
      <div className={styles.modalContent}>
        <img src="../images/ModalPaper.svg"></img>
        <div className={styles.modalForm}>
          {editField === "name" ? (
            <div>
              ...
              ></input>
              <hr></hr>
              <button className={styles.submitButton} onClick={editUserName}>확인</button>
            </div>
          ) : (
            <div>
              <h2>닉네임</h2>
              ...
              ></input>
              <hr></hr>
              <button className={styles.submitButton} onClick={editUserNickname}>확인</button>
            </div>
          )}
        </div>
      </div>
